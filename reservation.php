...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form role="form" method="POST" action="ajax.php" data-toggle="validator">
                ...
                <div class="col-lg-12">
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group col-lg-6">
                                    <label>Room Type</label>
                                    <select class="form-control" name="room_type" id="room_type" onchange="fetch_room(this.value);" required data-error="Select Room Type">
                                        <option selected disabled>Select Room Type</option>
                                        <?php
                                ...
                                <div class="form-group col-lg-6">
                                    <label>Room No</label>
                                    <select class="form-control" name="room_id" id="room_id" onchange="fetch_price(this.value)" required data-error="Select Room No">
                                ...
                                <div class="form-group col-lg-6">
                                    <label>Check In Date</label>
                                    <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="check_in" name="check_in" data-error="Select Check In Date" required>
                                    <div class="help-block with-errors"></div>
                                </div>

                                <div class="form-group col-lg-6">
                                    <label>Check Out Date</label>
                                    <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="check_out" name="check_out" data-error="Select Check Out Date" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control" placeholder="First Name" name="first_name" id="first_name" data-error="Enter First Name" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="number" class="form-control" data-error="Enter Min 10 Digit" data-minlength="10" placeholder="Contact No" id="contact_no" name="contact_no" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-6">
                                <label>Email Address</label>
                                <input type="email" class="form-control" placeholder="Email Address" id="email" name="email" data-error="Enter Valid Email Address" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-6">
                                <label>ID Card Type</label>
                                <select class="form-control" id="id_card_id" name="id_card_id" data-error="Select ID Card Type" required onchange="validId(this.value);">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" placeholder="ID Card Number" id="id_card_no" name="id_card_no" data-error="Enter Valid ID Card No" required>
                                <div class="help-block with-errors"></div>
                            </div>
                    ...
                    <button type="submit" name="booking" class="btn btn-lg btn-success pull-right" style="border-radius:0%">Submit</button>
                </div>
            </form>
        </div>
    </div>
